...
# rx conjuction source has 4 sources so we press until all 4 have a signal_type of 1
# So that rx receives a signal of the type 0
while len(rx_conjuction_presses) < 4:
    press()

result = lcm(*rx_conjuction_presses.values())
time_end = time.time()
